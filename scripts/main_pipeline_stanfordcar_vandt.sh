      ...
      do
        ...
        do
          ...
          do
            for SEED in 1 2 3
            do
              DIR=output/${DATASET}_vandt_2/${TRAINER}/${CFG}_${SHOTS}shots/nctx${NCTX}_csc${CSC}_ctp${CTP}/pretrain_${PRETRAINED}/iid_${IID}_repeatrate_${REPEATRATE}/${USERS}_users/lr_${LR}/${EPOCH}epoch_${ROUND}round/seed${SEED}
              if [ -d "$DIR" ]; then
